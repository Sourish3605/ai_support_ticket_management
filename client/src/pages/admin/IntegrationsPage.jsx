          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                >
                  <FiSettings className="w-3.5 h-3.5 text-slate-600" />
            ...
            {testResult && (
              <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-3.5 text-xs text-emerald-900 flex items-center justify-between">
                ...
                <button onClick={() => setTestResult(null)} className="text-emerald-700 font-bold cursor-pointer">
            ...
            <div className="bg-[#0052cc] text-white px-4 py-2.5 flex items-center justify-between shadow-sm select-none">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="text-white hover:bg-white/20 h-7 w-7 rounded-lg flex items-center justify-center transition cursor-pointer"
                >
            ...
            <div className="p-6 overflow-y-auto flex-1 grid lg:grid-cols-[1fr_320px] gap-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1.5">
                    <span className="bg-red-100 text-red-700 text-[10px] font-bold uppercase px-2 py-0.5 rounded flex items-center gap-1 font-mono">
                      <FiZap className="w-3 h-3 text-red-700" />
                      <span>{jiraConfig?.issue_type || "Incident"}</span>
                    </span>
                ...
                <div className="flex flex-wrap items-center gap-2 pt-2 border-t border-slate-100 text-xs">
                  ...
                  <span className="px-3 py-1.5 rounded-lg bg-slate-100 text-slate-700 font-semibold cursor-pointer hover:bg-slate-200 text-xs flex items-center gap-1">
            ...
            <div className="space-y-2 text-xs">
              ...
              <div className="flex justify-between">
                ...
                <span className="inline-flex items-center gap-1 font-bold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded">
                  <FiCheck className="w-3 h-3" />
                  <span>{selectedEmailModal.status || "DELIVERED"}</span>
                </span>
              </div>
            </div>
